...
| D1 | Second seed of `neurovision` (seed 43), 3 chained T4 sessions | `[~]` **launching 2026-09-20** on the current augmentation, as D0's NULL prescribes (`preregistration_multiseed.md`) | Three sessions complete at epoch 79, then `evaluate.py` on test/SSA/PED and the 12-comparison seed-to-seed family |
